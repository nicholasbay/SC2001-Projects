...
def main():
    ...
    #Comparing with Original Mergesort
    ...
    # Appending measurements to list_iv
    list_iv.append(dict_iv)

    # Collate all measurements for part iii into DataFrame
    df_iv = pd.DataFrame(list_iv)
    print(repr(df_iv))
    # Export DataFrame to Excel
    df_iv.to_excel(writer, sheet_name="c)iv)")
    # Process complete
    print("c)iv) done")
